...
<html>
  ...
  <?php echo link_tag('bootstrap.min.css')?>
   ...
   <body style="background-image:url(<?php echo base_url('assets/images/LIBRARY.jpg')?>); width: 25%; background-size: 100%;background-position: center center;background-repeat: no-repeat;">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <button type="button" class="btn btn-default btn-lg" style="margin-top:5%;font-family: Lato;font-size:2em;width:36%" onclick="openURL(6)">Search</button><br>
